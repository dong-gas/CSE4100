...
/* Search, Insertion, Deletion */
void Hash_Insert(struct hash *);
void Hash_Replace(struct hash *);
void Hash_Find(struct hash *);
void Hash_Delete(struct hash *);

/* Iteration. */
void Hash_Apply(struct hash *);
void act_square(struct hash_elem *, void *);
void act_triple(struct hash_elem *, void *);
void act_print(struct hash_elem *, void *);

/* Information. */
void Hash_Size(struct hash *);
void Hash_Empty(struct hash *);
